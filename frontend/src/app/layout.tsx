...
export const metadata: Metadata = {
  title: "QuizGen — AI Question Generator",
  description: "Generate exam questions from your learning materials using AI",
};
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <body
        ...
        style={{ background: "var(--at-bg)", color: "var(--at-text)" }}
      >
        <ThemeProvider>
          <AuthProvider>
            {children}
