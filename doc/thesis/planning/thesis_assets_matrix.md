...
| Figure 3.1  | 3       | Create from `doc/thesis/planning/architecture.md`   | Overall architecture of QuizGen                         | Show frontend, backend, SQLite, LLM providers                |
...
| Figure 3.4  | 3       | Create from `doc/thesis/planning/data_model.md`     | Entity relationship diagram of QuizGen                  | Redraw cleanly if Mermaid is not accepted                    |
...
| Figure 4.9  | 4       | `doc/screenshots/10-usage-dashboard.png`            | Usage telemetry dashboard                               | Already captured                                             |
| Figure 4.10 | 4       | `doc/screenshots/09-evaluation-dashboard.png`       | Evaluation dashboard showing latest baseline results    | Already captured                                             |
...
| Table 3.4: Database entities                 | 3       | users, documents, patterns, generations, quiz_attempts, api_calls   | `doc/thesis/planning/data_model.md`                          |
...
| Table 5.3: Core baseline comparison          | 5       | mean/std results                                                    | `eval/results/runs.csv` (core run id `2026-04-29T13:55:12Z`) |
| Table 5.4: Failure analysis                  | 5       | representative failures and mitigation                              | `eval/results/failure_analysis.md`                           |
| Table 6.1: Objective completion              | 6       | objective vs implementation evidence                                | `doc/thesis/planning/requirements.md`, screenshots           |
...
| Purpose         | Show confidence trend across stored attempts        |
