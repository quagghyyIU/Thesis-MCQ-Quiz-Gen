...
Implementation note: the current thesis draft uses a merged subsection
(`Scope and Objectives`) and an explicit `Research Questions` subsection.
This is accepted as long as all required objective and limitation content is
still covered.
...
- Use `doc/thesis/planning/architecture.md`.
...
- Use `doc/thesis/planning/data_model.md`.
...
- Integrated quiz practice and confidence trend analytics.
